...
# Function to detect and crop the relevant area
def detect_and_crop_area(image_path):
    # Read the image
...
def process_image(image_path):
    ...
    cropped_image = detect_and_crop_area(image_path)
    ...
    # Load the cropped image using docTR
